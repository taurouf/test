...
/* ============================================================
   Page "Création de commande Test" (simple, par cartes)
   ============================================================ */
function QuickTestPage() {
  // ---- États partagés avec la page avancée (mêmes comportements) ----
  ...
  // ——— Vérification de la clé (même logique que page avancée) ———
  useEffect(() => {
    let alive = true;
  ...
  // ——— Changement de restaurant : décision côté client + handshake en fond ———
  useEffect(() => {
    setModalOpen(false);
    setAllowMsg("");
    if (!restaurantId) {
    ...
    // Handshake proxy (ne change pas l'UI sur erreur)
  ...
  // ——— Charger juste le minimum : dishes + méthodes de paiement ———
  useEffect(() => {
